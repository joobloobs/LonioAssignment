!(function (e) {
  function r(r) {
    for (var n, i, p = r[0], l = r[1], f = r[2], c = 0, s = []; c < p.length; c++)
      ((i = p[c]),
  ...
  function t() {
    for (var e, r = 0; r < u.length; r++) {
      for (var t = u[r], n = !0, p = 1; p < t.length; p++) 0 !== o[t[p]] && (n = !1);
  ...
  ((i.m = e),
    ...
    (i.p = "https://www.services.zh.ch/app/quest/tarifbestimmung/prod/"));
